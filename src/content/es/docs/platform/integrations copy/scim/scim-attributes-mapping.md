...
imageAlt: "Illustration of data mapping for SCIM attributes"
...
type: article
canonical: 'https://learn.applivery.com/es/docs/platform/integrations/scim-attributes-mapping/'
...
Note Note that this is a premium feature that might not be available in your current plan. Check the availability in our [pricing page](https://www.applivery.com/pricing/).
